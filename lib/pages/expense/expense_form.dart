  ...
  Widget build(BuildContext context) {
    ...
    return BaseView<ExpenseModel>(
      onModelReady: (model) {
        ...
        if (isEditing) {
          responsiblePersonController.text = widget.expense?.responsiblePerson ?? '';
          descriptionController.text = widget.expense?.description ?? '';
          amountPriceController.text =
              widget.expense?.amount.toString() ?? '0';
            ...
            child: Column(
              ...
              children: <Widget>[
                InputField(
                  ...
                  placeholder: AppLocalizations.of(context).translate('responsiblePerson') +'*',
                ...
                InputField(
                  smallVersion: true,
                  isReadOnly: model.busy,
                  placeholder:AppLocalizations.of(context).translate('amount'),
                    ...
                    onPressed: () async {
                      if (_formKey.currentState.validate()) {
                        ...
                        model.saveExpense(
                          ...
                          amount:
                              double.parse(amountPriceController.text),
                          userId: null,
                        ));
